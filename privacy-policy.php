...
$stmt = $conn->prepare("SELECT * FROM pages WHERE slug = 'privacy-policy'");
$stmt->execute();
$page = $stmt->fetch();

$title = $page ? $page['title'] : 'Privacy Policy';
$content = $page ? $page['content'] : '<p class="text-center text-slate-500">Policy content coming soon...</p>';
    ...
    <div class="container mx-auto px-4 max-w-4xl">
        <div class="text-center mb-12 border-b border-slate-100 pb-10">
            ...
            <p class="text-slate-500 font-medium text-sm">
                Last Updated: <span class="text-slate-800"><?= $last_updated ?></span>
            </p>
        </div>
